...
const MusicMobile = ({ data }) => {
  ...
  const [play, setPlay] = useState([
    {
      song: "/music/HymnePDIPerjuangan/hymne.mp3",
      minusOne: "/music/HymnePDIPerjuangan/Hymneminusone.mp3",
      pdf: "/music/HymnePDIPerjuangan/Hymne.pdf",
      lyric: `
    ...
    {
      song: "/music/MarsPDIPerjuangan/MARS.mp3",
      minusOne: "/music/MarsPDIPerjuangan/MARSminusone.mp3",
      pdf: "/music/MarsPDIPerjuangan/MARS.pdf",
      lyric: `
              <p>
              LIRIK
              <br/>
    ...
    {
      song: "/music/OneForAllAllForOne/AllForOne.mp3",
      minusOne: "/music/OneForAllAllForOne/AllForOneMinusOne.mp3",
      pdf: "/music/OneForAllAllForOne/AllForOne.pdf",
      lyric: `
              <p>
              LIRIK
              <br/>
    ...
    {
      song: "/music/SolidBergerak/SolidBergerak.mp3",
      minusOne: "/music/SolidBergerak/SolidBergerakMinusOne.mp3",
      pdf: "/music/SolidBergerak/SolidBergerak.pdf",
      lyric: `
              <p>
              LIRIK
              <br/>
    ...
    <div className="musicPdiMobile">
      <div className="wrapperMobileMusic">
        <div className="headlineMusic">
          <img src="/img/laguperjuangan.png" alt="" width="70" />
