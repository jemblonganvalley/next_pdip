    ...
    <>
      ...
      <div className="containerMapsNusantara">
        <div className="container-position-pulau-inMaps">
          ...
          {/* 12 */}
          <CardProvinsi
            img="/img/Kalimantan-Barat.png"
            display={show12 ? "flex" : "none"}
          />

          {/* 13 */}
          <CardProvinsi
            img="/img/Kalimantan-Selatan.png"
            display={show13 ? "flex" : "none"}
          />

          {/* 14 */}
          <CardProvinsi
            img="/img/Kalimantan-Tengah.png"
            display={show14 ? "flex" : "none"}
          />

          {/* 15 */}
          <CardProvinsi
            img="/img/Kalimantan-Timur.png"
            display={show15 ? "flex" : "none"}
          />

          {/* 16 */}
          <CardProvinsi
            img="/img/Kalimantan-Utara.png"
            display={show16 ? "flex" : "none"}
          />

          {/* 17 */}
          <CardProvinsi
            img="/img/Kepulauan-Riau.png"
          ...
          {/* 21 */}
          <CardProvinsi
            img="/img/Nusa-Tenggara-Barat.png"
            display={show21 ? "flex" : "none"}
          />

          {/* 22 */}
          <CardProvinsi
            img="/img/Nusa-Tenggara-TImur.png"
          ...
          {/* 26 */}
          <CardProvinsi
            img="/img/Sulawesi-Barat.png"
            display={show26 ? "flex" : "none"}
          />

          {/* 27 */}
          <CardProvinsi
            img="/img/Sulawesi-Selatan.png"
            display={show27 ? "flex" : "none"}
          />

          {/* 28 */}
          <CardProvinsi
            img="/img/Sulawesi-Tengah.png"
            display={show28 ? "flex" : "none"}
          />

          {/* 29 */}
          <CardProvinsi
            img="/img/Sulawesi-Tenggara.png"
            display={show29 ? "flex" : "none"}
          />

          {/* 30 */}
          <CardProvinsi
            img="/img/Sulawesi-Utara.png"
            display={show30 ? "flex" : "none"}
          />

          {/* 31 */}
          <CardProvinsi
            img="/img/Sumatera-Barat.png"
            display={show31 ? "flex" : "none"}
          />

          {/* 32 */}
          <CardProvinsi
            img="/img/Sumatera-Selatan.png"
            display={show32 ? "flex" : "none"}
          />

          {/* 33 */}
          <CardProvinsi
            img="/img/Sumatera-Utara.png"
